...
urlpatterns = [
    ...
    path('cbd-collections/<slug:slug>/', views.cbd_collections_product_list, name='cbd_collections_product_list'),
        re_path(r'^cbd-collections/(?P<slug>[\w-]+)/.*$', views.cbd_collections_product_list, name='cbd_collections_extra'),
    ...
    path('sticker-collections/<slug:slug>/', views.sticker_collections_product_list, name='sticker_collections_product_list'),
        re_path(r'^sticker-collections/(?P<slug>[\w-]+)/.*$', views.sticker_collections_product_list, name='sticker_collections_extra'),

    path('pre-made-sticker-shop/<slug:slug>/', views.sticker_sub_collections_list, name='sticker_sub_collections_list'),
        re_path(r'^pre-made-sticker-shop/(?P<slug>[\w-]+)/.*$', views.sticker_sub_collections_list, name='sticker_sub_collections_extra'),

    
    
    path('pre-made-sticker-shop/<slug:slug>/', views.sticker_sub_collections_product_list, name='sticker_sub_collections_product_list'),
