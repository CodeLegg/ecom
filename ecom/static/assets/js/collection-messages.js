// Store your collection messages with keys matching collection slugs URL's
const collectionMessages = {
    
    "flower-packaging": `
        Please note only 
        <a href=""><strong>custom (bespoke) packaging</strong></a> 
        and 
        <a href=""><strong>blank packaging</strong></a> 
        for 
    ...
    'extract-packaging': `
        <h4>
            ...
            <a href="https://www.slapsta.co.uk/collections/extract-packaging" title="Extract Packaging | No Labels | SLAPSTA">without labels</a>, 
            <a href="https://www.slapsta.co.uk/collections/custom-extract-packaging" title="Custom Extract Packaging | SLAPSTA">upload your own artwork</a>, 
            or 
            <a href="https://www.slapsta.co.uk/collections/design-services" title="Design Services | SLAPSTA">work with our designers to create your product or brand's packaging.</a>
        </h4>
        <br>
        <p>
            For a <a href="https://www.slapsta.co.uk/pages/get-a-quote" title="Get a Quote | SLAPSTA">bespoke quote,</a> or to discuss a unique packaging option for your brand or product, please 
            <a href="https://www.slapsta.co.uk/pages/get-a-quote" title="Contact Us | SLAPSTA">contact us.</a>
            <br>
        </p>
    `,
    ...
    'design-services': `
        ...
        <div>
            ...
            <a href="mailto:info@slapsta.co.uk" title="Contact Us.">get in touch!</a>
        </div>
    `,
    ...
    'print-services': `
        <div>
            <span>
                <a title="Get a Quote | SLAPSTA" href="https://slapsta.com/pages/get-a-quote">
        ...
        <div>
            <strong>If you need a specific size, orientation, material, finish, quantity per roll, or all edges trimmed for mechanical application, please contact us for a 
                <a title="Get a Print Quote | Sheets or Rolls | SLAPSTA" href="https://www.slapsta.co.uk/pages/get-a-print-quote">custom print quote.</a>
            </strong>
        </div>
        <div>
    ...
    'blank-packaging': `
        ...
        <p>
            ...
            <strong><a href="https://www.slapsta.co.uk/collections/custom-cannabis-packaging" title="Custom Packaging | SLAPSTA">‘Custom Packaging’</a></strong>. 
            Here you can 
            <strong><a href="https://www.slapsta.co.uk/collections/custom-cannabis-packaging" title="Custom Packaging | SLAPSTA">upload your own artwork</a></strong>, 
            or see the 
            <strong><a href="https://www.slapsta.co.uk/collections/design-services" title="Design Services | SLAPSTA">‘Design Services’</a></strong> 
            section to 
            <a href="https://www.slapsta.co.uk/collections/custom-cannabis-packaging" title="Custom Packaging | SLAPSTA">
        ...
        <p>
            ...
            <a href="https://www.slapsta.co.uk/pages/get-a-quote" title="Contact Us | SLAPSTA">
    ...
    'custom-packaging': `
        <div>
            ...
            <a href="mailto:info@slapsta.co.uk" title="Contact Us | SLAPSTA">Contact us now!</a>
            <br>
        </div>
        <div>
    ...
    'ready-made-packaging': `
        ...
        <p>
            ...
            <a href="https://www.slapsta.co.uk/collections/custom-cannabis-packaging" title="Custom Dispensary Packaging | SLAPSTA">custom packaging section.</a>
        </p>
    `,
    ...
    'pop-top-vial-stickers': `
        <div>
            Perfect for 
            <a href="https://www.slapsta.co.uk/collections/poptops" title="POP TOP VIALS | SLAPSTA">Pop-Top Vials</a>, 
            <a href="https://www.slapsta.co.uk/collections/glassjars" title="GLASS JARS | SLAPSTA">Jar lids</a>, 
            <a href="https://www.slapsta.co.uk/collections/blank-mylar-bags" title="MYLAR BAGS | SLAPSTA">Mylar Bags</a>, and more.
        </div>
        <div>
    ...
    'mylar-bag-labels': `
        ...
        <p>
            These labels perfectly fit our range of <strong><a href="https://slapsta.com/collections/blank-mylar-bags" title="Mylar Bags | SLAPSTA">mylar bags</a></strong>. 
    ...
    'rectangle-pre-roll-sticker-labels': `
        <h4>
            ...
            <a href="https://www.slapsta.co.uk/collections/blank-mylar-bags" title="MYLAR BAGS | SLAPSTA">Mylar Bags</a>, 
            <a href="https://www.slapsta.co.uk/collections/glassjars" title="GLASS JARS | SLAPSTA">Glass Jars</a>, and more! 
            They can also be selected in a <a href="https://www.slapsta.co.uk/collections/pre-roll-tubes" title="Pre-Roll Tubes | SLAPSTA">Pre-Roll</a> size.
        </h4>
        <br>
        <p>
    ...
    'ready-made-stickers-labels': `
        <h2>BUY 4 SETS, GET 1 SET FREE</h2>
        <p>Universal info labels, QR labels, and strain labels designed to fit various types of packaging. <a href="https://slapsta.com/pages/contact-us" title="Contact Us | SLAPSTA">Contact us</a> for custom sizing.</p>
    ...
    'custom-glass-jars': `
        <p>Selection of glass flower and concentrate packaging. All comes supplied with screw tops. All artwork is checked by humans and we will contact you if we think any edits are required. Or work with our <a href="https://slapsta.com/collections/design-services" title="Design Services | SLAPSTA">design team</a> to create your perfect packaging labels!</p>
    `,
    ...
    // Add more collection messages here as needed
};



// Function to render the collection message
function renderCollectionMessage(collection) {
	const messageContainer = document.getElementById("collection-message");

	// Check if the collection has a message
	if (collectionMessages[collection]) {
		messageContainer.innerHTML = collectionMessages[collection];
		messageContainer.style.display = "block"; // Show the container if message exists
	} else {
		messageContainer.style.display = "none"; // Hide if no message exists
	}
}

// Call the function to render the message for the current collection
